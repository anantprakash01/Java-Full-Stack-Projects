      ...
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden round-lg max-w-[30rem] maz-h-[35rem]">
              <img
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => (
                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[4rem] max-h-[5rem] mt-4">
                  <img
                    src={item.src}
                    alt={item.alt}
                    className="h-full w-full object-cover object-center"
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">45245 Ratings</p>
                  <p className="text-ms ml-3 font-medium text-indigo-600 hover:text-indigo-500 cursor-pointer">
                    42433 Reviews
                  </p>
                </div>
              </div>
                      ...
                      <Grid item xs={5}>
                        ...
                        <Box className="mt-4 space-y-3">
                          ...
                          <Grid container alignItems={"center"} gap={2}>
                            ...
                            <Grid item xs={7}>
                              <LinearProgress sx={{bgcolor:'#d0d0d0', borderRadius:4, height:7}} variant='determinate' value={30} text-yellow-300/>
                            </Grid>
                          </Grid>
                          <Grid container alignItems={"center"} gap={2}>
                            <Grid item xs={2}>
